let url ='https://raw.githubusercontent.com/freeCodeCamp/ProjectReferenceData/master/global-temperature.json' //import data
let req = new XMLHttpRequest()


let baseTemp
let values =  [ ] // store the array of 'monthlyVariance'
...
let drawCells = () => {
    ...
    canvas.selectAll('rect')
            ...
            .attr('data-temp', (item) => {
                return baseTemp+item['variance']  //temp = basetemperature + variance
            })
